	...
	<table border="0" width="1140px" cellspacing="0" cellpadding="0" id="table1">
		...
		<tr>
			...
			<td class="login_msg" width="400">
				<form action="${pageContext.request.contextPath}/html/frame.html">
					...
					<input class="btn" type="button" value=" 注册 " onclick="document.location='${pageContext.request.contextPath}/emp_registUI.action'"/>
